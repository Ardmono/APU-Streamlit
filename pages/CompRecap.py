...
lifters = len(dfsex[df['Sex'] =='M']) + len(dfsex[df['Sex'] =='M'])
...
a.metric(label="How Many Lifters", value=len(dfsex[df['Sex'] =='F']))
b.metric(label="How Many Lifters", value=len(dfsex[df['Sex'] =='M']))
c.metric(label="How Many Lifters", value=lifters)
